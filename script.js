...
function renderizarTarefas(){
    ...
    // limpar a listagem de intens antes de renderizar novamente a tela
    lista.innerHTML = '';
    ...
    for(tarefa of tarefas){
        ...
        // Adicionar evento do clique no item da lista
...
// 1)_ precisamos "escutar" o evento de clique no botão
btn.onclick = function(){
    // 2) Fazer a captura do valor digitado pelo usuário no input
    ...
    if(novaTarefa !== ""){
        ...
        let msg = document.createTextNode('Nenhuma tarefa informada, você precisa informar a tarefa!');
